...
public class TakeTalonComponent extends SkinnableComponent {
    ...
    public function TakeTalonComponent() {

    }

    public function  set setTakeTicketText(takeTicketText:String):void{
        this.takeTicketText=takeTicketText;
    }

    private var currentAction:Function;

    public function  set setCurrentAction(currentAction:Function):void{
    ...
    {
        shadowVisible = true;
/*       ss  removeButtonListeners();
        setTimeout( addButtonListeners, 1500 );
        onTicketClickedSignal.dispatch();*/

        if (currentAction is  Function) currentAction();
